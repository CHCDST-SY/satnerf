...
def get_opts():
    ...
    parser.add_argument('--root_dir', type=str, 
                        default="/home/sy/code/satdataset/root_dir/crops_rpcs_ba_v2/JAX_068",
                        help='root directory of the input dataset')
    parser.add_argument('--img_dir', type=str, 
                        default="/home/sy/code/satdataset/DFC2019/Track3-RGB-crops/JAX_068",
                        help='Directory where the images are located (if different than root_dir)')
    parser.add_argument("--ckpts_dir", type=str, 
                        default="/home/sy/code/satdataset/SatNeRF_output/ckpts",
                        help="output directory to save trained models")
    parser.add_argument("--logs_dir", type=str, 
                        default="/home/sy/code/satdataset/SatNeRF_output/logs",
                        help="output directory to save experiment logs")
    parser.add_argument('--gt_dir', type=str, 
                        default="/home/sy/code/satdataset/DFC2019/Track3-Truth",
                        help='directory where the ground truth DSM is located (if available)')
    parser.add_argument('--cache_dir', type=str, 
                        default="/home/sy/code/satdataset/cache_dir/crops_rpcs_ba_v2/JAX_068_ds1 ",
    ...
    parser.add_argument("--model", type=str, default="sat-nerf-hash", choices=["nerf", "s-nerf", "sat-nerf", "sat-nerf-hash"],
